...
class BalanceCalibrationForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['measurement_range', 'date_calibration', 'update', 'next_due', 'std_id', 'calibrator', 'certificate_issuer', 'certificate_number', 'status', 'priority',
                  'linear_conventional_mass', 'linear_displayed_value', 'linear_error', 'linear_uncertainty',
                  'linear_conventional_mass_2', 'linear_displayed_value_2', 'linear_error_2', 'linear_uncertainty_2',
                  'linear_conventional_mass_3', 'linear_displayed_value_3', 'linear_error_3', 'linear_uncertainty_3',
                  'linear_conventional_mass_4', 'linear_displayed_value_4', 'linear_error_4', 'linear_uncertainty_4',
                  'linear_conventional_mass_5', 'linear_displayed_value_5', 'linear_error_5', 'linear_uncertainty_5']
        widgets = {
